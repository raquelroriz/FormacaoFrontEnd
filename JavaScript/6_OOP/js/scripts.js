...
// 13 - getter (é usado para exibir o valor) e setter (para alterar valor)
class Post {
...
// 14 - Herança (extends = adicionar classe que vai trazer as propriedades, super = enviar valores para a classe pai)
class Mamifero {
  constructor(patas) {
    this.patas = patas;
  }
...
// 15 - instanceof (verifica se é pai de outro)
