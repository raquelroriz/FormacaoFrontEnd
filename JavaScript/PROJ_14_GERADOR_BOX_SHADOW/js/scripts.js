...
// no constructor é onde recebemos os argumentos
class BoxShadowGenerator {
  ...
  } // aqui escolhe o que quer fazer com eles
  ...
  applyRule() {
    const rgbValue = this.hexTorRgb(this.colorRef.value)
      //OBS: fiquei quase louca aqui, porque eu tinha dado quebra de linha, e esse puto quebra na visualização tbm (-,-)
  ...
  // aqui se recebe a cor, mas precisamos transformar, porque recebemos em exadecimal
  hexTorRgb(hex) {
